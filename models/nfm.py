...
# @Time: 2020/10/12 20:15

import tensorflow as tf
from tensorflow.python.keras import Model
from tensorflow.python.keras.layers import Concatenate, Lambda, BatchNormalization, Dense, Add, Multiply
...
class NFM(BaseModel):
    ...
    def prediction_layer(self):
        ...
        '''FM layer'''
        exFM_out_search = BiInteractionPooling()(self.fm_input)
        ...
        '''FM layer'''
        exFM_out_recommend = BiInteractionPooling()(self.fm_input)
